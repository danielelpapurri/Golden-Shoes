    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('accesorios') ? 'active' : '' }}" href="{{ route('accesorios') }}">Urbanos</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li><a href="{{ route('formales') }}">Colección Formales / Casual (Premium)</a></li>
                    <li><a href="{{ route('deportivos') }}">Colección Deportivos (Performance)</a></li>
                    <li><a href="{{ route('accesorios') }}">Colección Urbanos (Lifestyle)</a></li>

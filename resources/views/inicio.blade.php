...
<div class="row g-4 mb-5">
    <div class="col-md-4">
        <div class="card text-white overflow-hidden">
            <img src="{{ asset('fotos/formales.png') }}"
            ...
            <div class="card-img-overlay d-flex flex-column justify-content-end"
                ...
                <a href="{{ route('formales') }}" class="btn btn-golden btn-sm w-50">Ver más</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card text-white overflow-hidden">
            <img src="{{ asset('fotos/deportivos.png') }}"
            ...
            <div class="card-img-overlay d-flex flex-column justify-content-end"
                ...
                <a href="{{ route('formales') }}" class="btn btn-secondary btn-sm w-50">Ver más</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card overflow-hidden">
            <img src="{{ asset('fotos/urbanos.png') }}"
            ...
            <div class="card-img-overlay d-flex flex-column justify-content-end"
                ...
                <a href="{{ route('formales') }}" class="btn btn-outline-dark btn-sm w-50">Ver más</a>
            </div>
        </div>
    </div>
</div>

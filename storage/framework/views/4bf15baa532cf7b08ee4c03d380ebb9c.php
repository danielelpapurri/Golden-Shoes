...
<div class="row align-items-center g-4 mb-5 p-4 bg-white rounded-3">
    <div class="col-md-8">
        ...
        <div class="d-flex gap-3">
            <a href="<?php echo e(route('menu')); ?>" class="btn btn-golden px-4">Ver Colección</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\segundoTaller\resources\views/inicio.blade.php ENDPATH**/ ?>